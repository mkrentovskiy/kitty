...
MemoryLCD::MemoryLCD(unsigned char inMode)
{
	...
	lcdtemp=addFont("orbit",(F_C_I *) orbitron10ptDescriptors,(unsigned char *) orbitron10ptBitmaps);
	this->curFont = NULL;
...
*/
void MemoryLCD::printBitmap(int i, int j, int* imgBuff, int size_i, int size_j)
{
